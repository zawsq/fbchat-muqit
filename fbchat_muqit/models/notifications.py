...
class friendRequestList(
    Struct, frozen=True, eq=False, tag="mobile_requests_count", tag_field="type"
):
...
class friendUpdated(
    Struct, frozen=True, eq=False, tag="jewel_requests_remove_old", tag_field="type"
):
...
class FriendRequestState(
    Struct, frozen=True, eq=False, tag="friending_state_change", tag_field="type"
):
...
class PokeNotification(
    Struct, frozen=True, eq=False, tag="live_poke", tag_field="type"
):
    """Poked user details"""
...
class friendRequestSeen(
    Struct, frozen=True, eq=False, tag="friend_requests_seen", tag_field="type"
):
    pass


class NotificationSeen(
    Struct, frozen=True, eq=False, tag="notifications_seen", tag_field="type"
):
    pass


class NavigationNotify(
    Struct, frozen=True, eq=False, tag="nav_update_counts", tag_field="type"
):
    pass


class ConfirmedFriend(
    Struct, frozen=True, eq=False, tag="jewel_friending_notifs", tag_field="type"
):
    pass


FacebookNotifications = Union[
    friendRequestList,
    friendUpdated,
    FriendRequestState,
    PokeNotification,
