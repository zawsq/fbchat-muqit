...
class addedParticipant(Struct, frozen=True, eq=False):
    ...
    last_unsubscribed: Optional[str] = field(
        name="lastUnsubscribeTimestampMs", default=None
    )
    """join timestamp"""
...
class ApprovalMode(
    Struct, frozen=True, eq=False, tag="ApprovalMode", tag_field="class"
):
...
class ApprovalQueue(
    Struct, frozen=True, eq=False, tag="ApprovalQueue", tag_field="class"
):
...
class JoinableMode(
    Struct, frozen=True, eq=False, tag="JoinableMode", tag_field="class"
):
...
class ParticipantsAdded(
    ...
    frozen=True,
    eq=False,
    tag="ParticipantsAddedToGroupThread",
    tag_field="class",
):
...
class ParticipantLeft(
    Struct, frozen=True, eq=False, tag="ParticipantLeftGroupThread", tag_field="class"
):
...
class AdminRemoved(
    Struct, frozen=True, eq=False, tag="AdminRemovedFromGroupThread", tag_field="class"
):
...
class ChangeViwerStatus(Struct, frozen=True, eq=False):
    ...
    is_messenger_blocked: Optional[bool] = field(
        name="isMsgBlockedByViewer", default=None
    )
    """If User is blocked on Messenger"""
    messenger_blocked_timestamp: Optional[int] = field(
        name="isMsgBlockedTimestamp", default=None
    )
    """The block event timestamp"""
    is_facebook_blocked: Optional[bool] = field(
        name="isFBBlockedByViewer", default=None
    )
    """If the User is blocked in Facebook."""
    facebook_blocked_timestamp: Optional[int] = field(
        name="isFBBlockedTimestamp", default=None
    )
...
class ThreadMuteSettings(
    Struct, frozen=True, eq=False, tag="ThreadMuteSettings", tag_field="class"
):
...
class ThreadAction(
    Struct, frozen=True, eq=False, tag="ThreadAction", tag_field="class"
):
...
class ThreadFolderMove(
    Struct, frozen=True, eq=False, tag="ThreadFolder", tag_field="class"
):
...
class ThreadDelete(
    Struct, frozen=True, eq=False, tag="ThreadDelete", tag_field="class"
):
